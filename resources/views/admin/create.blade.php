...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-between">
            ...
            @csrf
                <div class="mb-3">
                    <label for="name" class="form-label">Inserisci url</label>
                ...
                <div class="mb-3">
                    <label for="language_dev" class="form-label">Inserisci titolo Fumetto</label>
                ...
                <div class="mb-3">
                    <label for="framework" class="form-label">Inserisci prezzo</label>
                ...
                <div class="mb-3">
                    <label for="start_date" class="form-label">Inserisci data</label>
